...
public class TestClass extends Pojo{
	...
	public void loginToUserAccount() {
		...
		kiteZerodhaLoginPage.sendKiteLoginPageUsername("GSN400");
		kiteZerodhaLoginPage.sendKiteLoginPagePassword("@Jaygajanan");
		kiteZerodhaLoginPage.clickKiteLoginPageLogin();
		kiteZerodhaLoginPage.sendKiteLoginPagePin("512151");
